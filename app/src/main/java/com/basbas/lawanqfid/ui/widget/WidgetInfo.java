...
import com.basbas.lawanqfid.MainActivity;
...
import com.basbas.lawanqfid.ui.home.HomeActivity;
...
public class WidgetInfo extends AppWidgetProvider {
    ...
    static void updateAppWidget(Context context, final AppWidgetManager appWidgetManager,
        ...
        views.setTextViewText(R.id.tv_date, "Di Update Tanggal :"+currentDateandTime);
