...
import com.basbas.lawanqfid.utama.ui.youtube.YoutubeActivity
...
class AdapterYoutube(private val itemData: List<DataItemYoutube>, private val contex: Context)
...
//            .into(holder.image)
        ...
        holder.itemView.setOnClickListener {
            ...
            val intent = Intent(contex, YoutubeActivity::class.java)
